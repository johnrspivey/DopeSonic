...
export default function ToneAdvisor() {
    ...
    <>
      ...
      <div className="ds-body">
        ...
        {cur==="amp" && <>
          ...
          <TA label="Key pedals / effects in chain" k="pedals" placeholder="e.g. Tube Screamer then Whammy then Carbon Copy delay" data={data} setData={setData} />
          <div className="ds-nav">
            <button className="btn-back" onClick={prev}>← Back</button>
            <button className="btn-next" onClick={next}>Next →</button>
          </div>
        ...
        {cur==="speakers" && <>
          ...
          <div className="ds-sub">What you hear shapes how you dial in.</div>
        ...
        {cur==="playback" && <>
          ...
          <div className="ds-sub">Where will this tone ultimately be heard?</div>
